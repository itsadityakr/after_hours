...
Put a few test numbers next to their step counts — 14 takes 6, 8 takes 4, 123
takes 12 — and notice how little the count moves while the numbers race ahead.
Ask what the steps are counting, and hint 5 has already told you: the halvings.

## 7. If none of that was enough

One loop, one counter, \`num != 0\`. The loop itself and what it costs are on the
**Notes** tab.
`;export{e as default};